...
CREATE TABLE IF NOT EXISTS permissions (
    id BIGSERIAL PRIMARY KEY, resource VARCHAR(64) NOT NULL,
    action VARCHAR(32) NOT NULL, description TEXT,
...
CREATE TABLE IF NOT EXISTS oauth2_clients (
    id BIGSERIAL PRIMARY KEY, client_id VARCHAR(64) NOT NULL,
    client_secret_hash VARCHAR(255) NOT NULL, name VARCHAR(128) NOT NULL,
    redirect_uris JSONB NOT NULL DEFAULT '[]', scopes JSONB NOT NULL DEFAULT '[]',
...
CREATE TABLE IF NOT EXISTS oauth2_authorization_codes (
    id BIGSERIAL PRIMARY KEY, code VARCHAR(128) NOT NULL,
    client_id VARCHAR(64) NOT NULL, user_id BIGINT NOT NULL REFERENCES users(id),
    redirect_uri TEXT NOT NULL, scopes JSONB NOT NULL DEFAULT '[]',
    code_challenge VARCHAR(128), code_challenge_method VARCHAR(8),
...
CREATE TABLE IF NOT EXISTS oauth2_tokens (
    id BIGSERIAL PRIMARY KEY, jti VARCHAR(64) NOT NULL,
    client_id VARCHAR(64) NOT NULL, user_id BIGINT NOT NULL REFERENCES users(id),
    scopes JSONB NOT NULL DEFAULT '[]', refresh_token VARCHAR(512) NOT NULL,
