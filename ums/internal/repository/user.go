...
func (r *userRepo) FindByID(ctx context.Context, id int64) (*model.User, error) {
	...
	if errors.Is(err, gorm.ErrRecordNotFound) { return nil, nil }; return &u, err
}
...
func (r *userRepo) Update(ctx context.Context, u *model.User) error { return r.db.WithContext(ctx).Save(u).Error }
