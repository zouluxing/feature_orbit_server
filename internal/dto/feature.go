...
// FeatureInfo is the API response shape for a Feature.
...
// CreateFeatureRequest is the body for POST /api/v1/features.
...
// UpdateFeatureRequest is the body for PUT /api/v1/features/:id.
...
// FeatureListRequest are the query params for GET /api/v1/features.
...
// FeatureListResponse is the paginated list response.
...
// ToFeatureInfo maps a model.Feature to a FeatureInfo DTO.
